~(function(win){
	var htmls = '<span class="tousu_btn_mess">上传附件：</span>' +
				'<div class="layui-input-inline">' +
				'<input type="file" name="filename" id="fileToUpload" class="imgFiles" style="display: none" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" multiple>'+
				'<div class="zh_clear tousu_btn">' +
				'	<div class="layui-btn upload_btn imgClick">'+
				'		选择附件'+
				'	</div>'+
				'    <b>'+
				'        （可上传3个附件，每个附件大小不得超过5M）'+
				'    </b>'+
				'</div>' +
				'<div class="imgAll">'+
				'    <ul>'+
