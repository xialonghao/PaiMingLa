                    ...
                    if (!u) {
                        ...
                        g.on("click", function() {
                            var e = t(this)
                              , a = e.attr("lay-value")
                              , n = p.attr("lay-filter");
                            var ce = document.createEvent("HTMLEvents");ce.initEvent("change", false, true);e.parents(".layui-form-select").prev().val(a);var select_ = e.parents(".layui-form-select").prev()[0];select_.attachEvent ? select_.fireEvent("onchange"):select_.dispatchEvent(ce);
